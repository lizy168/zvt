...
def get_main_tag_info(session: Session = Depends(get_app_db_session)):
    """Get main_tag info"""
...
def get_sub_tag_info(session: Session = Depends(get_app_db_session)):
    """Get sub_tag info"""
...
def get_main_tag_sub_tag_relation(main_tag: str, session: Session = Depends(get_app_db_session)):
...
def get_industry_info(session: Session = Depends(get_app_db_session)):
    """Get industry info"""
...
def get_main_tag_industry_relation(main_tag: str, session: Session = Depends(get_app_db_session)):
...
def get_hidden_tag_info(session: Session = Depends(get_app_db_session)):
    """Get hidden_tag info"""
...
def create_main_tag_info(
    tag_info: CreateTagInfoModel, session: Session = Depends(get_app_db_session)
):
...
def delete_main_tag(tag: str, session: Session = Depends(get_app_db_session)):
...
def create_sub_tag_info(tag_info: CreateTagInfoModel, session: Session = Depends(get_app_db_session)):
...
def delete_sub_tag(tag: str, session: Session = Depends(get_app_db_session)):
...
def delete_hidden_tag(tag: str, session: Session = Depends(get_app_db_session)):
...
def get_stock_tag_options(entity_id: str, session: Session = Depends(get_app_db_session)):
...
def set_stock_tags(
    set_stock_tags_model: SetStockTagsModel, session: Session = Depends(get_app_db_session)
):
    """Set stock tags"""
